...
# pacman -S --noconfirm mingw-w64-ucrt-x86_64-gcc		#GCC C and C++ compilier tools
# pacman -S --noconfirm --needed base-devel mingw-w64-ucrt-x86_64-toolchain

# Array of packages to check and install

PACKAGES=(
	"mingw-w64-ucrt-x86_64-pkg-config"		# package management tools
	"mingw-w64-ucrt-x86_64-cmake"			# cmake tools
	"mingw-w64-ucrt-x86_64-cmake-gui"		# chame gui tools
	"mingw-w64-ucrt-x86_64-make" 			# make utility
	"mingw-w64-ucrt-x86_64-ninja"			# nija utility
