...
class CosineSource(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "CosineSource")
        ...
        self.freq = freq = 1380000

        ##################################################
        # Blocks
        ##################################################

        self.zeromq_pull_source_0 = zeromq.pull_source(gr.sizeof_short, 1, 'tcp://127.0.0.1:5555', 100, False, (-1), False)
        ...
        self.connect((self.zeromq_pull_source_0, 0), (self.blocks_interleaved_short_to_complex_0, 0))
...
def main(top_block_cls=CosineSource, options=None):
